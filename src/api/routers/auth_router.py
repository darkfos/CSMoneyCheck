...
async def login_user(
    ...
    response.set_cookie(
        key=AuthService.config.JWT_ACCESS_COOKIE_NAME, value=token_data.access_token # noqa
    )
    response.set_cookie(
        AuthService.config.JWT_REFRESH_COOKIE_NAME, value=token_data.refresh_token # noqa
    )
